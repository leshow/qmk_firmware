 ...
 */
        ...
        [BASE] = KEYMAP(TG(4), KC_1, KC_2, KC_3, KC_4, KC_5, KC_ESCAPE, KC_DELETE, KC_Q, KC_W, KC_E, KC_R, KC_T, M(LAUNCH_TERM), GUI_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, LT(3, KC_G), KC_LSHIFT, CTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, SFT_T(KC_CAPSLOCK), SCMD_T(KC_NO), KC_LALT, KC_APPLICATION, KC_INSERT, KC_LCTL, KC_INSERT, KC_CAPSLOCK, KC_HOME, LT(1, KC_BSPACE), LT(2, KC_DELETE), KC_END, KC_ESCAPE, KC_6, KC_7, KC_8, KC_9, KC_0, TG(4), M(LAUNCH_ROFI), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPACE, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, GUI_T(KC_QUOTE), SFT_T(KC_CAPSLOCK), KC_N, KC_M, KC_COMMA, ALT_T(KC_DOT), CTL_T(KC_SLASH), KC_LSHIFT, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, SCMD_T(KC_NO), KC_LALT, KC_RCTRL, KC_PGUP, KC_PGDOWN, KC_ENTER, LT(1, KC_SPACE)),
