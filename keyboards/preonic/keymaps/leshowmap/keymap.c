...
#define LSYMB LT(_SYMB, KC_BSPACE)
#define RSYMB LT(_SYMB, KC_SPC)
...
[_QWERTY] = {
  ...
  {KC_DEL,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPACE},
  ...
  {M(LAUNCH_TERM), MO(_UCODE), LGUI(KC_LSFT), KC_LCTRL, LSYMB, SFDEL,   SFENT,   RSYMB,   KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT} },
...
[_ARRW] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,   KC_PGUP},
