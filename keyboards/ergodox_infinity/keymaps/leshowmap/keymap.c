 ...
 */
    ...
    [SYMB] = LAYOUT_ergodox(
        ...
        _______, KC_QUES, KC_CIRC, KC_HASH, KC_PERC, KC_ASTR, _______,
 ...
 */
    ...
    [NUMSE] = LAYOUT_ergodox(
        ...
        _______, _______, KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, _______,
        _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,
        // thumb
        _______, _______, _______, _______, _______, _______, // added here
 ...
 */
    [ARRW] = LAYOUT_ergodox(_______, _______, _______, _______, _______, _______, _______,
                            ...
                            _______, _______, KC_HOME, KC_PGUP, KC_PGDOWN, KC_END, KC_PGUP,
 ...
 */
    ...
    [UCODE] = LAYOUT_ergodox(
        _______, _______, _______, _______, _______, _______, _______,
        _______, UC(0x2620), UC(0x03BB), UC(0x222A), UC(0x2229), UC(0x00D7), _______,
