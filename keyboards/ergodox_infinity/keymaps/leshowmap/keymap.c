 ...
 * |--------+------+------+------+------+------| SCMD |           | SCMD |------+------+------+------+------+--------|
 * | (/LShf |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  | ./Alt| //Ctl| RShft/)|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | cap/shft |  Alt | Down |  Up  | Ctrl |                                       |  <-  | Down |  up  |  ->  | SCMD |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 ...
 */
        ...
        [BASE] = LAYOUT_ergodox( // layer 0 : default
            ...
            KC_LSPO, CTL_T(KC_Z), KC_X, KC_C, KC_V, KC_B, SCMD_T(KC_NO),
            SFT_T(KC_CAPSLOCK), KC_LALT, KC_DOWN, KC_UP, KC_LCTL,
            // thumb
            ...
            SCMD_T(KC_NO), KC_N, KC_M, KC_COMMA, ALT_T(KC_DOT), CTL_T(KC_SLASH), KC_RSPC,
            KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, SFT_T(KC_CAPSLOCK),
            // thumb
 ...
 */
        ...
        [SYMB] = LAYOUT_ergodox(
            ...
            KC_TRNS, KC_TRNS, KC_COMMA, KC_DOT, KC_GRAVE, KC_PLUS, KC_TRNS,
