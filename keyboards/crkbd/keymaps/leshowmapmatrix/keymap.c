...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //,-----------------------------------------.                ,-----------------------------------------.
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _______, KC_BSLS, KC_AMPR, KC_LBRC, KC_RBRC, KC_MINUS,           KC_UNDS, KC_LPRN, KC_RPRN, KC_DLR, KC_COLN, KC_DQUO,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
 ...
 //,-----------------------------------------.                ,-----------------------------------------.
    ...
    //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    _______, _______, _______, _______, _______, _______,                  QK_REPEAT_KEY, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, CW_TOGG, \
    //|------+------+------+------+------+------|                |------+------+------+------+------+------|
 ...
 //,-----------------------------------------.                ,-----------------------------------------.
    ...
    //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    _______, _______, _______, _______, _______, _______,                 KC_INS, KC_CAPS_LOCK, KC_PSCR, _______, _______, _______, \
    //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                _______, _______, _______,     _______, _______, _______\
                             //`-----------------------'  `----------------------'
  ),
