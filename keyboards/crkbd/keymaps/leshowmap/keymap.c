...
#define QWERTY 7  // qwerty layer for games
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //,-----------------------------------------.                ,-----------------------------------------.
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
        LCTL_T(KC_ESC), LT(NUM, KC_DEL), LT(SYMB, KC_SPC),            LT(SYMB,KC_BSPC), SGUI_T(KC_ENT), LT(ADJUST,KC_ESC) \
                                       //`--------------------'  `--------------------'
  ),
...
_______, KC_QUOT, KC_COMMA, KC_DOT, KC_GRAVE, KC_PLUS,     KC_0, KC_1, KC_2, KC_3, _______, _______, \
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                       DF(QWERTY), KC_NO, KC_NO,                KC_NO, KC_NO, KC_NO \
    ),

    [QWERTY] = LAYOUT( \
 //,-----------------------------------------.                ,-----------------------------------------.
     KC_DEL, KC_Q, KC_W, KC_E, KC_R, KC_T,                     KC_Y, KC_U, KC_I, KC_O, KC_P, DF(BASE),\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
     KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G,          KC_H, KC_J, KC_K, KC_L, KC_SCLN, GUI_T(KC_QUOT),\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
