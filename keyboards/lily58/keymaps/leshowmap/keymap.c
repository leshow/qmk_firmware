...
[ADJUST] = LAYOUT( \
  ...
  RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, KC_NO,        _______, _______,         KC_NO, KC_NO, KC_NO, RGB_M_X, RGB_M_SW, RGB_M_R, \
                             _______, DF(QWERTY), KC_NO, KC_NO,                        KC_NO, KC_NO, KC_NO, _______ \
),
...
[QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, _______,    LGUI(KC_X), KC_N, KC_M, KC_COMM, RALT_T(KC_DOT), LCTL_T(KC_SLSH), KC_RSFT, \
        KC_LALT, KC_LCTL, KC_SPC, KC_ENT,                        KC_BSPC, KC_ENT, KC_ESC, KC_TAB \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
